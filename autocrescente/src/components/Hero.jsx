      ...
      <div className="relative h-full max-w-7xl mx-auto grid md:grid-cols-2">
        <div className="flex flex-col justify-center px-6 sm:px-12 py-16 sm:py-20">
          {onBack && (
            <button
              onClick={onBack}
              className="text-white/70 hover:text-white text-sm mb-6 flex items-center gap-1 transition-colors w-fit"
            >
              ← Início
            </button>
          )}
          ...
          <p
            ...
            style={{ textShadow: "0 1px 6px rgba(0,0,0,0.6)" }}
          >
            A Auto Crescente procura atrair e manter os melhores talentos. No
